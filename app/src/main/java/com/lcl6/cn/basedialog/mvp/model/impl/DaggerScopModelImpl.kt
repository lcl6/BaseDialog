...
class DaggerScopModelImpl : DaggerScopModel {

    internal var mList: MutableList<String> = ArrayList()

    override fun getData(listener: DaggerScopModel.LoadCompleteListener) {
