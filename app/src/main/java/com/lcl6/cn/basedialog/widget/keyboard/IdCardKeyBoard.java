package com.lcl6.cn.basedialog.widget.keyboard;
...
/**
 * Created by liancl on 2019/1/22.
 */
public class IdCardKeyBoard extends android.support.v7.widget.AppCompatEditText implements KeyboardView.OnKeyboardActionListener,
    ...
    public IdCardKeyBoard(Context context) {
        this(context, null);
    }
    ...
    public IdCardKeyBoard(Context context, AttributeSet attrs, int defStyleAttr) {
