...
public class SimpleButton extends View {
    ...
    private void _init(Context context, AttributeSet attrs) {
        mBorderWidth = DensityUtils.dp2px( 0.5f);
        mRadius = DensityUtils.dp2px( 5f);
        mHorizontalPadding = (int) DensityUtils.dp2px( 5f);
        mVerticalPadding = (int) DensityUtils.dp2px( 5f);
        mIconPadding = (int) DensityUtils.dp2px( 3f);
        mTextSize = DensityUtils.sp2px(14f);
